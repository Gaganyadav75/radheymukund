...
export function SaleDetails({sno,desc,qty,unit,gstrate,hsn,per,amt}) {
    ...
    return (
      <div className="grid child:p-1 child:flex child:flex-col child:justify-center  child:text-wrap grid-cols-[1fr,3fr,1.5fr,1fr,1.5fr,1fr,2fr]  border-b border-black min-h-8">
